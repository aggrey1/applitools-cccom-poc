...
public class CCTest_Copy {
	private static final Logger log = LogManager.getLogger(CCTest_Copy.class.getName());
    ...
    private Eyes setupEyes() {
        Eyes eyes = new Eyes();
       // eyes.setApiKey(System.getenv("tmIXBSQQB5d7bVf7yUBa29iSZEuWdRcrseEbvLmcNaM110")); // TODO: Applitools API Key Here
        eyes.setApiKey("tmIXBSQQB5d7bVf7yUBa29iSZEuWdRcrseEbvLmcNaM110");
        eyes.setBatch(batch);
    ...
    private void loadMore() throws InterruptedException {
    	  ...
    	  while(itr.hasNext()) {
    		    WebElement showMoreButton = itr.next();
    		     System.out.println("start to click the show more button");
